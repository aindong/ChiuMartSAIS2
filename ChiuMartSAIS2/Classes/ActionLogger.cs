...
namespace ChiuMartSAIS2.Classes
{
    class ActionLogger
    {
        ...
        public static void LogAction(string quantity, string unit_id, string product_id, string log_type, string relationId, string clientId, string paymentMethod, string price, string supplierPrice, string supplierId)
        {
